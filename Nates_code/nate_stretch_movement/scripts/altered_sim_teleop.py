...
class KeyboardTeleopNode:
    ...
    def send_command(self, command):
        ...
        trajectory_client = actionlib.SimpleActionClient('/stretch_head_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
    ...
    def trajectory_client_selector(self, command):
        self.trajectory_client = actionlib.SimpleActionClient('/stretch_head_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
