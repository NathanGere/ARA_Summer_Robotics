...
void cloud_cb(const sensor_msgs::PointCloud2ConstPtr &cloud_msg)
{
    ...
    ROS_INFO("Width: %d", cloud_msg->width); //640
    ROS_INFO("Height: %d", cloud_msg->height); //480
    //ROS_INFO("PointField (count): %d", cloud_msg->fields.point_step);
...
{
    ros::init(argc, argv, "point_cloud_test_node");
    ros::NodeHandle n;
